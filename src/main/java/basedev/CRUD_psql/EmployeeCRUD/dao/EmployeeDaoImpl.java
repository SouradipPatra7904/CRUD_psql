package basedev.CRUD_psql.EmployeeCRUD.dao;
...
import basedev.CRUD_psql.EmployeeCRUD.mapper.EmployeeRowMapper;
...
public class EmployeeDaoImpl implements EmployeeDao{
	...
	public void executeUpdateEmployee(Employee emp) {
		 ...
		 template.execute(sql,map,new PreparedStatementCallback<Object>() {  
			    @Override  
			    public Object doInPreparedStatement(@NonNull PreparedStatement ps)  
